...
def get_student_attempts():
    ...
    stu_1 = ASTNode('run', None, [
        ASTNode('put_marker'),
        ASTNode('repeat', '4', [
            ASTNode('move'), ASTNode('put_marker'),
            ASTNode('move'), ASTNode('pick_marker')
        ]),
        ASTNode('put_marker'),
        ASTNode('move')
    ])
    ...
    stu_2 =ASTNode('run', None, [
        ...
        ASTNode('move'),
        ASTNode('repeat', '2', [
            ASTNode('ifelse', 'bool_marker', [
                ASTNode('do', 'bool_marker', [
                    ASTNode('pick_marker')
                ]),
                ASTNode('else', 'bool_marker', [
                    ASTNode('move')
                ]),
            ]),
            ASTNode('put_marker'),
    ...
    stu_3 = ASTNode('run', None, [
        ASTNode('ifelse', 'bool_no_marker', [
            ASTNode('do', 'bool_no_marker', [
                ASTNode('repeat', '2', [
                    ASTNode('put_marker'), ASTNode('move'), ASTNode('move')
                ])
            ]),
            ASTNode('else', 'bool_no_marker', [
                ASTNode('repeat', '2', [
...
def get_basic_data_for_task(folder='', save = True):
    ...
    if save:
        print("Saving the contents of task-4...")
