...
def get_solution_code():
    ...
    code = ASTNode('run', None, [ASTNode('repeat_until_goal', 'bool_goal',
                                          [ASTNode('move'),
...
def get_solution_code_symast_format():
    ...
    '''
    code = AST('run', [
        AST('while(bool_goal)', [AST('move'),
        AST('if(bool_path_left)', [
                                     AST('do', [AST('turn_left')])
                                 ])
                                 ])
    ])
...
def get_student_attempts():
    ...
    stu_0 = ASTNode('run', None, [
        ASTNode('move'), ASTNode('move'), ASTNode('move'), ASTNode('move'), ASTNode('move'),
        ASTNode('turn_right'),
        ASTNode('move'), ASTNode('move'), ASTNode('move'), ASTNode('move'), ASTNode('move'), ASTNode('move'),
        ASTNode('turn_left'),
        ASTNode('move'), ASTNode('move'), ASTNode('move'), ASTNode('move'), ASTNode('move'), ASTNode('move'),
        ASTNode('turn_right'),
    ...
    stu_1 = ASTNode('run', None, [
        ...
        ASTNode('turn_left'), ASTNode('move'), ASTNode('move'), ASTNode('move')
    ])
    sketch_1 = GenerateSketch(stu_1, type='hoc')
    ...
    sketch_2 = GenerateSketch(stu_2, type='hoc')
    ...
    sketch_3 = GenerateSketch(stu_3, type='hoc')
...
def get_basic_data_for_task(folder='', save = True):
    ...
    if save:
        print("Saving the contents of task-1...")
