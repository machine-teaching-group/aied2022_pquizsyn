...
def get_student_attempts():
    ...
    stu_2 = ASTNode('run', None, [
        ASTNode('repeat_until_goal', 'bool_goal', [
            ASTNode('ifelse', 'bool_path_ahead', [
                ASTNode('do', 'bool_path_ahead', [ASTNode('turn_left')]),
                ASTNode('else', 'bool_path_ahead', [ASTNode('move')])
            ])
        ])
    ])
    ...
    stu_3 = ASTNode('run', None, [
        ASTNode('ifelse', 'bool_path_ahead', [
            ...
            ASTNode('else', 'bool_path_ahead', [
                ASTNode('ifelse', 'bool_path_left', [
                    ASTNode('do', 'bool_path_left', [
                        ASTNode('turn_left')
                    ]),
                    ASTNode('else', 'bool_path_left', [
                        ASTNode('ifelse', 'bool_path_ahead', [
                            ASTNode('do', 'bool_path_ahead', [
                                ASTNode('move'), ASTNode('move')
                            ]),
...
def get_basic_data_for_task(folder='', save = True):
    ...
    if save:
        print("Saving the contents of task-2...")
