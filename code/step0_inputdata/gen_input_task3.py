...
def get_student_attempts():
    ...
    stu_1 = ASTNode('run', None, [
        ASTNode('repeat_until_goal', 'bool_goal', [
            ASTNode('move'), ASTNode('move'), ASTNode('turn_right')
        ])
    ])
    ...
    stu_2 = ASTNode('run', None, [
        ASTNode('repeat_until_goal', 'bool_goal', [ASTNode('ifelse', 'bool_path_right',
                                                           [ASTNode('do', 'bool_path_right',
                                                                    [ASTNode('turn_left')]),
                                                            ASTNode('else', 'bool_path_right',
                                                                    [ASTNode('ifelse',
                                                                             'bool_path_left',
                                                                             [ASTNode('do',
                                                                                      'bool_path_left',
    ...
    stu_3 = ASTNode('run', None, [ASTNode('ifelse', 'bool_path_ahead', [
        ASTNode('do', 'bool_path_ahead', [
            ASTNode('move')
        ]),
        ASTNode('else', 'bool_path_ahead', [
...
def get_basic_data_for_task(folder='', save = True):
    ...
    if save:
        print("Saving the contents of task-3...")
