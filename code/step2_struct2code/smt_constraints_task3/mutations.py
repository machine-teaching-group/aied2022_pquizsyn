import json
import os
from code.step2_struct2code.smt_constraints_task3.utils_ast_smt import ASTNode, json_to_ast, ast_to_json
from code.step2_struct2code.smt_constraints_task3.z3_constraints import generate_assignments, get_p_star, generate_ast_nodes_from_assignments


def get_all_mutations(thresh=2, type='hoc'):
...
if __name__ == "__main__":
    ...
    output_folder = 'data/output/task-3/substructure-3/all-mutations/'
